...
ActiveRecord::Base.transaction do
  ...
  #BUSINESS
    ...
    fog_harbor_fish_house = Business.create!(business_name: "Fog Harbor Fish House", address_1: "Pier 39 Ste A-202", city: "San Francisco", state: "CA", zip_code: "94133", latitude: 37.809639, longitude: -122.410248, rating: 4, business_info: "Seafood", phone_number: "4154212442", category_id: restaurant.id)
    begoni_bistro = Business.create!(business_name: "Begoni Bistro", address_1: "615 Jackson Street", city: "San Francisco", state: "CA", zip_code: "94133", latitude: 37.796000, longitude: -122.405550, rating: 4, business_info: "Chinese", phone_number: "4157570120", category_id: restaurant.id)
    #boba
  ...
  #REVIEWS
    ...
    #FogHarborFishHouse
    review72 = Review.create!(body: "Service was good we came here to have some wine and fresh oysters. I love the oysters they were very fresh. I did expect the chowder to be really good but it was ok for me.", user_id: user3.id, business_id: fog_harbor_fish_house.id, rating: 5)
    review73 = Review.create!(body: "I joined the wait list on Yelp (30-45 min), but after a few minutes, the bartender (Tony) noticed I was alone and told me there was someone about to leave the bar area and I could snatch that seat (so nice of him!).
    The clam chowder wasn't great, but not bad at all! I absolutely loved the sour dough bread roll that came with it.", user_id: user4.id, business_id: fog_harbor_fish_house.id, rating: 3)
    review74 = Review.create!(body: "Everything I had here for lunch was excellent. I was surprised at the generous sized portions! The ahi tuna poke was a gorgeous display of tuna, mangoes and avocado. The clam chowder with crabmeat was thick, rich, creamy and oh so delicious! It was chock full of tender crabmeat. Next came the spectacular crab and avocado caesar salad; all the ingredients were quality and the crab meat was generous. The dressing was excellent and not overpowering, and the avocado and bacon crumbles added the perfect touch. From our table we enjoyed a perfect view of the Pier 39 harbor. Service was outstanding.", user_id: user5.id, business_id: fog_harbor_fish_house.id, rating: 4)
    review75 = Review.create!(body: "The clam chowder was savory and delicious. I wished they had them in cans! The garlic crab was just okay. The crab was over cooked and had too much butter for me. It's been hours later and I'm still choking from the butter in my throat.", user_id: user6.id, business_id: fog_harbor_fish_house.id, rating: 5)
    review76 = Review.create!(body: "This place was pretty good, but pricey (as expected for a restaurant on the pier). We ordered a few things - oysters, mussels with fries, scallops risotto. The oysters were fresh and delicious. The mussels were nice and tasty, the broth tasted delicious with the fries. The risotto left something to be desired. They only gave 4 scallops, I feel as though it should've at least come with 6. I felt like they could've given a bit more for an expensive dish. The risotto was okay, nothing special. 
    Overall, the service was great and the food was okay.", user_id: user7.id, business_id: fog_harbor_fish_house.id, rating: 4)
    review77 = Review.create!(body: "Let me just start by saying how wonderful was everything ! Our waiter Adam was amazing! He was checking on us all the time, if we needed anything, fill up out waters etc... We ordered the clam chowder soup!oh my God!!!!! The best we ever had!!! The clam platter as well as the seafood platter and the mussels.... was SUPER!!!!
    After fog restaurant we will never go to another restaurant in San Francisco!
    My husband and I don't even remember when was the last time we had such an amazing food in a restaurant!", user_id: user8.id, business_id: fog_harbor_fish_house.id, rating: 3)
    review78 = Review.create!(body: "This place started off at 3 stars based on first impression- super busy touristy restaurant that took us at least 10 minutes for someone to notice us after being seated, even to get our drink orders. I was truly hesitant about the quality of the food here after realizing it was located in the heart of Fisherman's wharf. But to my pleasant surprise, the pricy food slightly exceeded our expectations. My foodie partner in crime, Natalie M., and I shared the famed clam chowder bowl and scallops and Dungeness crab risotto, both of which I would highly recommend. The sourdough bread is great too, and they refill it no charge. Our waitress tried to make up for neglecting us initially by throwing in a couple extra sourdough rolls to go..it helped. 
    Good place overall, if you have patience to wait and fight through the crowds of tourists.", user_id: user1.id, business_id: fog_harbor_fish_house.id, rating: 2)

    #BegoniBistro
    review79 = Review.create!(body: "This was an amazing meal with even better service and atmosphere! The shanghai dumplings are unreal", user_id: user6.id, business_id: begoni_bistro.id, rating: 5)
    review80 = Review.create!(body: "We went to Begoni Bistro in China Town for dinner last month and will definitely be going back! It was a Monday night, so the area was not crowded and we easily got a table. The service aws very quick. We ordered Pork Buns, Egg Rolls, and Kung Pao Chicken. Come prepared to eat a lot! The Kung Pao was incredible, not exactly health food but very delicious and just barely spicy. The Pork Buns were just as good as any I've ever had before, hot and steamed to perfection. Our third pick, the egg rolls were better than most egg rolls, this makes a good appetizer to your meal. 
    We ended up stuffed to the brim with food leftover. Definitely stop by this place if you're in the area and feeling hungry!", user_id: user7.id, business_id: begoni_bistro.id, rating: 3)
    review81 = Review.create!(body: "Yawped  'good dim sum' place and ended up at this place in Chinatown. Fortunately it was a less busy Sunday in the area and upon walking to this place we stumbled upon about five other dim sum places (figures). 
    It's a very cozy and warm atmosphere and they have plenty of wine and a few beer and tea selections. We got here around 3(yes, dim sum at 3) , so they no longer had their lunch menu and their dim sum options were limited and quite pricey. I ordered several dumplings (at $8/ea) and also ordered an entree of beef ribs with a side of rice and it was delicious. The dim sum selection was okay, my favorite was the custard bun!
    ", user_id: user5.id, business_id: begoni_bistro.id, rating: 4)
    review82 = Review.create!(body: "Lovely place for dim sum. Loved everything we ordered but especially the Kung Pao chicken (yes, I realize that's not dim sum but it was the best Kung Pao we ever had). A bit of a wait as we went during the lunch rush but they moved things along really well.", user_id: user1.id, business_id: begoni_bistro.id, rating: 5)
    review83 = Review.create!(body: "I decided to try this restaurant with my sisters and I based off of my search results on Yawp. Arriving at around 4:00 PM, I was surprised to see a small establishment that was not quite busy--although it may have meant this place is unpopular, it did make the environment relaxing. 
    We were served by a waiter relatively quick and our food arrived to us about 20 minutes after having had placed our order. The food was average. We ordered garlic noodles, chicken wings (which I believe were sweet and sour), and soup dumplings. The garlic noodles required more salt and they didn't look very appealing but still edible. The chicken wings were a bit off but good in flavor. The soup dumplings were not memorable. I wish the restaurant provided a traditional style dim sum experience and put more effort into the quality of food.  I was not severely disappointed by my meal but I was not highly satisfied either.", user_id: user2.id, business_id: begoni_bistro.id, rating: 4)
    review84 = Review.create!(body: "I wife and I went here once on a weeknight and we enjoyed it. Food is good mostly focused on Cantonese cuisine. The restaurant is set up maximize the amount of people in it and so it's sometimes a little loud. The night that we were there there were a lot of groups that had come straight from work and were eating there as a happy hour place. The volume is definitely loud although this could be good for a group of tourists or for families. Food is probably mid tier pricing for San Francisco - not the most expensive but also not a big bargain either. 
    This restaurant is a great choice for those who are looking for a safe bet in terms of solid Chinese food but also good quality. A lot of the other spots in Chinatown are excellent in quality and in food, but they may not have a setup that is accessible to those who are new to Chinese food. This place keeps it simple for a wide variety if audiences. We will go back because the quality of the food is high, and while it's not an out of this word Cantonese experience, the food is solid. 
    Get the dim sum and the eggplant!!!", user_id: user3.id, business_id: begoni_bistro.id, rating: 3)
    review85 = Review.create!(body: "Not much dim sum. But decent Chinese food at low SF prices. Book via Yelp to skip the wait. In the heart of Chinatown, so the whole goal is table turnover. Get people fed and move them along.
    There are much better Chinese restaurants in SF but if you are in this neighborhood and need to eat quick, this place is pretty good.", user_id: user4.id, business_id: begoni_bistro.id, rating: 2)
  ...
  #BUSINESS_PICTURES
    ...
    fog_harbor_fish_house.photos.attach(io: File.open('./app/assets/images/business/restaurants/fog-harbor-fish-house/fog-harbor-fish-house-1.jpg'), filename: 'fog-harbor-fish-house-1.jpg')
    fog_harbor_fish_house.photos.attach(io: File.open('./app/assets/images/business/restaurants/fog-harbor-fish-house/fog-harbor-fish-house-2.jpg'), filename: 'fog-harbor-fish-house-2.jpg')
    fog_harbor_fish_house.photos.attach(io: File.open('./app/assets/images/business/restaurants/fog-harbor-fish-house/fog-harbor-fish-house-3.jpg'), filename: 'fog-harbor-fish-house-3.jpg')
    begoni_bistro.photos.attach(io: File.open('./app/assets/images/business/restaurants/begoni-bistro/begoni-bistro-1.jpg'), filename: 'begoni-bistro-1.jpg')
    begoni_bistro.photos.attach(io: File.open('./app/assets/images/business/restaurants/begoni-bistro/begoni-bistro-2.jpg'), filename: 'begoni-bistro-2.jpg')
    begoni_bistro.photos.attach(io: File.open('./app/assets/images/business/restaurants/begoni-bistro/begoni-bistro-3.jpg'), filename: 'begoni-bistro-3.jpg')
